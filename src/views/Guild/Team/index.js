    ...
    return (
      <Grid className="Team Container">
        <Row className="Card">
          ...
          <Col md={9} xs={12}>
            <PageHeader className="pageHeader">Yarnila Graumond<small>Founder</small></PageHeader>
        ...
        <Row className="Card">
          ...
          <Col lg={9} md={9} sm={12} xs={12}>
            <PageHeader className="pageHeader">Leksur Ackus<small>Founder</small></PageHeader>
        ...
        <Row className="Card">
          ...
          <Col md={9} sm={12} xs={12}>
            <PageHeader className="pageHeader">Kodiack Ironclaw</PageHeader>
