              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.primary_race
                      ? {
                          value: Admin.User.primary_race,
                          label: Admin.User.primary_race
                        }
                      : null
                  }
              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.primary_role
                      ? {
                          value: Admin.User.primary_role,
                          label: Admin.User.primary_role
                        }
                      : null
                  }
                  ...
                  options={
                    Admin.User.primary_race
                      ? raceRoleClassOptions[Admin.User.primary_race]
                          .roleOptions
                      : []
                  }
                  isClearable={true}
              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.primary_class
                      ? {
                          value: Admin.User.primary_class,
                          label: Admin.User.primary_class
                        }
                      : null
                  }
                  onChange={(e, a) =>
                    this.selectOnChange(e, a, "primary_class")
                  }
                  options={
                    Admin.User.primary_race
                      ? raceRoleClassOptions[Admin.User.primary_race]
                          .classOptions[Admin.User.primary_role]
                      : []
                  }
                  isClearable={true}
                  isSearchable={true}
              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.secondary_race
                      ? {
                          value: Admin.User.secondary_race,
                          label: Admin.User.secondary_race
                        }
                      : null
                  }
                  onChange={(e, a) =>
                    this.selectOnChange(e, a, "secondary_race")
                  }
                  options={raceOptions}
                  isClearable={true}
                  isSearchable={true}
              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.secondary_role
                      ? {
                          value: Admin.User.secondary_role,
                          label: Admin.User.secondary_role
                        }
                      : null
                  }
                  onChange={(e, a) =>
                    this.selectOnChange(e, a, "secondary_role")
                  }
                  options={
                    Admin.User.secondary_race
                      ? raceRoleClassOptions[Admin.User.secondary_race]
                          .roleOptions
                      : []
                  }
                  isClearable={true}
              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.secondary_class
                      ? {
                          value: Admin.User.secondary_class,
                          label: Admin.User.secondary_class
                        }
                      : null
                  }
                  onChange={(e, a) =>
                  ...
                  options={
                    Admin.User.secondary_race
                      ? raceRoleClassOptions[Admin.User.secondary_race]
                          .classOptions[Admin.User.secondary_role]
                      : []
                  }
                  isClearable={true}
                  isSearchable={true}
              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.profession
                      ? {
                          value: Admin.User.profession,
                          label: Admin.User.profession
                        }
                      : null
                  }
              ...
              <FormGroup>
                <Select
                  value={
                    Admin.User.profession_specialization
                      ? {
                          value: Admin.User.profession_specialization,
                          label: Admin.User.profession_specialization
                        }
                      : null
                  }
                  onChange={(e, a) =>
                  ...
                  options={
                    professionSpecializationOptions[Admin.User.profession]
                  }
                  isClearable={true}
                  isSearchable={true}
                  onBlur={e => e.preventDefault()}
