...
class App extends Component {
  ...
  getState = props => {
    ...
    if(Cookies.get('User_LoginToken') && this.props.User.id && !/edit|new/.test(location.pathname)) this.interval = setInterval(() => this.props.getUser(this.props.User.id), 10000)
