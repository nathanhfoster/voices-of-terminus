...
class App extends Component {
  ...
  getState = props => {
    ...
    if(Cookies.get('User_LoginToken') && User.id && !['/edit/', '/new/'].some(e => location.pathname.includes(e))) this.interval = setInterval(() => this.props.refreshUser(this.props.User.id, this.props.User.token), 1000)
