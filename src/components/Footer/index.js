 ...
 */
  ...
  render() {
    ...
    return ([
      ...
      <FontAwesomeIcon icon={showFooterIcon[showFooter ? 1 : 0]} className="footerButton" onClick={this.toggleFooter}size="2x"/>,
      <Collapse isOpened={showFooter} className="FooterContainer" height={126}>
          <Grid>
            <Row>
