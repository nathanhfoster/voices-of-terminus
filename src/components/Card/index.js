        ...
        {summary ?
          <div className="Summary inlineNoWrap">
            ...
            <div className="cardInfo">
              <div><i className="fas fa-user"/><Link to={'/profile/' + author} onClick={(e) => e.stopPropagation()}>{author_username}</Link> <i className="far fa-clock"/><Moment fromNow>{date_created}</Moment></div>
