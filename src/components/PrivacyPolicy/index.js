...
class PrivacyPolicy extends PureComponent {
  ...
  render() {
    return (
      <Grid className="PrivacyPolicy Container">
        <Row>
          <Col xs={12}>
            <PageHeader className="pageHeader">Privacy Policy</PageHeader>

            <p>Effective date: December 11, 2018</p>

            <p>
              Voices of Terminus ("us", "we", or "our") operates the
              https://voices-of-terminus.herokuapp.com/ website (the "Service").
            </p>
            ...
            <p>
              Voices of Terminus uses the collected data for various purposes:
            </p>
            <ul>
            ...
            <p>
              Voices of Terminus will take all steps reasonably necessary to
            ...
            <p>
              Voices of Terminus may disclose your Personal Data in the good
              faith belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of Voices of
                Terminus
              </li>
              <li>
